...
<template>
  <Modal :title="`Delete Board - \'${props.board.title}\'`" name="delete-board" :onModalClose="onModalClose">
    <div class="space-y-4 flex flex-col items-center">
      ...
      <div class="flex items-center justify-end gap-2 *:cursor-pointer">
        <fwb-button @click="modalStore.closeModal('delete-board')" color="dark">No</fwb-button>
